<template>
	<div>
		...
		<div class="card">
			<div class="card-header border-bottom">
				<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Inicio / </span> Todas las operaciones</h4>
			</div>
      <div class="row">
        <div class="card-body">
          <div class="row justify-content-center">
            <div class="col-12">
              <div class="row   align-items-end">
                ...
                <div class="col-6 col-lg-2 mt-3 mt-md-0" >
		...
		<div class="modal fade modal-lg" id="operationModal" v-if="showPass == 1" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-simple modal-add-new-cc row">
        <div class="modal-content p-0 p-md-3">
          <div class="modal-body py-1 px-0 px-md-3">
            ...
            <div class="w-100  px-3 mt-2 mb-2">
              <div class="dropdown card-title text-center d-flex justify-content-center">
                <button class=" d-flex justify-content-center text-primary  align-items-baseline mx-2" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                    <i class="fa-regular fa-user fa-xl text-primary me-2"></i>
                    <h6 class="text-primary">Ver Usuario</h6>
                </button>
                <div class="dropdown-menu w-100 p-4 user-info-dropdown" aria-labelledby="dropdownMenuButton1">
                  <div class="d-flex justify-content-between ">
                    <h6><strong>Nombre completo / Razón Social:</strong></h6>
                    <h6>
                      {{ 
                        selectedOperation.bank_account_send.personal_account 
                        ? selectedOperation.bank_account_send.personal_account.name + ' ' + selectedOperation.bank_account_send.personal_account.surname 
                  ...
                  <div class="d-flex justify-content-between ">
                    ...
                    <h6>
                      {{ 
                        selectedOperation.bank_account_send.personal_account 
                        ? selectedOperation.bank_account_send.personal_account.document_type.name
                        : 'RUC'
                      }}
                    </h6>
                  </div>
                  <div class="d-flex justify-content-between ">
                    ...
                    <h6>
                      {{ 
                        selectedOperation.bank_account_send.personal_account 
                        ? selectedOperation.bank_account_send.personal_account.document_number
                        : selectedOperation.bank_account_send.company_account.ruc
                      }}
                    </h6>
                  </div>
                  <div class="d-flex justify-content-between ">
                    ...
                    <h6 class="mb-0">
                      {{ 
                        selectedOperation.bank_account_send.personal_account 
                        ? selectedOperation.bank_account_send.personal_account.user.email
                        : selectedOperation.bank_account_send.company_account.user.email
                      }}
                    </h6>
                  </div>
                </div>
            ...
            <div class="w-100 row justify-content-between mx-0 mt-2 mb-2">
								<h6 class="card-title text-center mb-2 text-md-start col-12 col-md-6 px-md-0" v-if="selectedOperation.operation_number != '' ">
            ...
            <div class="d-flex justify-content-between px-3 align-items-center amount_section mt-0 mb-2 py-1">
                <div  class="col-8">
									<h6 class=" mb-0"><strong class="fw-bold text-primary">Recibiste:</strong></h6>
                  <h4 class="mb-0 text-primary">
                    {{ selectedOperation.bank_account_send.coin_type_id == 1 ? 'S/.' : '$' }} {{ $func.numberFormat(selectedOperation.amount) }}
                  </h4>
                </div>
                <div class="col-4">
                  <h6 class="mt-2 mb-0 h8 fw-light row px-0 justify-content-center text-center">
										<strong class="fw-bold text-primary col-12 col-md-6 px-1 text-center text-md-end">Tienes que enviar:</strong> 
                    <span class="col-12 w-auto fw-bold px-1 text-center text-md-start">
                      {{selectedOperation.bank_account_receive.coin_type_id == 1 ? 'S/.' : '$'}} {{$func.numberFormat(selectedOperation.change_amount)}} 
                    </span>
									</h6>
                  <h6 class="mb-2 h8 fw-light row px-0 text-center mt-1 mt-md-0">
                    ...
                    <span class="col-12 w-auto fw-bold px-0 text-center text-md-start">
                      {{selectedOperation.exchange_rate.toFixed(3)}} 
                    </span>
									</h6>
                </div>
            </div>
              ...
              <div class="d-flex flex-column justify-content-center align-items-center">
                ...
                <div class="col-12 px-0 py-1 my-1 ">
                  <div class="col-12  d-flex flex-column  align-items-center card-transfer2" style="">
                    <div class=""><h6 class="mb-0  mt-2">Cuenta de origen</h6></div>
                ...
                <div class="col-12 px-0 py-1 my-1 ">
                  <div class="col-12  d-flex flex-column  align-items-center align-items-center card-transfer" style="">
                    <div class=""><h6 class="mb-0  mt-2">Cuenta de transferencia</h6></div>
                    <div class="d-flex div-small justify-content-between align-items-center col-12 px-3 ">
                      <div>
                        ...
                        <h6 class="text-img-converte  fw-bold">
                          ...
                          selectedOperation.bank_account_transfer.company_account.business_name
                          }}
                        </h6>
                      </div>
                      <div class="d-flex">
                ...
                <div class="col-12 px-0 py-1 my-1 ">
                  <div class="col-12  d-flex flex-column  align-items-center card-transfer2" style="">
                    <div class=""><h6 class="mb-0  mt-2">Cuenta de destino</h6></div>
                    <div class="d-flex div-small justify-content-between align-items-center col-12 px-3 ">
                      <div>
    ...
    <div class="modal fade " id="processModal" v-if="showPass == 2 || showPass == 3" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-simple modal-add-new-cc row">
            ...
            <div class="d-flex flex-column px-2 mb-3">
              <div class="d-flex  justify-content-center align-items-center">
                <div class="col-6 d-flex justify-content-center mt-3">
                  <button class="btn btn-label-secondary  align-items-baseline w-75" @click="hideModal()"> 
                  	<span class="align-middle d-inline-block ">Cerrar</span>
                  </button>
                </div>
                <div class="col-6 d-flex justify-content-center mt-3">
                  <button class="btn btn-primary  align-items-baseline w-75" @click="changeStatus($event)"> 
                  	<span class="align-middle d-inline-block ">Continuar</span>
                  </button>
                </div>
              </div>
            </div>
...
<script>
    import { OPERATIONS_CHANGE_STATUS, GET_OPERATION_BY_ID} from "@/core/services/store/operation.module";
    ...
    export default {
        ...
        methods: {
                  ...
                  columnDefs: [
                    ...
                    
                    {
                      ...
                      render: function (data, type, full, meta) {
                        ...
                        return (
                          `${ date.getDate() }/${ (date.getMonth()+1) > 9 ? (date.getMonth()+1) : '0' + (date.getMonth()+1) }/${ date.getFullYear() } ` 
                        )
                      }
                    },
                    { 
                      ...
                      render: function (data, type, full, meta) {
                        let $clientName = full.bank_account_send.personal_account 
                          ? full.bank_account_send.personal_account.name + ' ' + full.bank_account_send.personal_account.surname 
                    ...
                    { 
                      ...
                      responsivePriority: 4,
                      render: function (data, type, full, meta) {
                        let $coinType = full.bank_account_receive.coin_type;
                    ...
                    },
                    {
                      ...
                      render: function (data, type, full, meta) {
                        var html = `<div class="d-flex align-items-center justify-content-around">
                                      <a href="javascript:;" class="text-body"><i data-operation=${full.id}  class="fas fa-eye view-op"></i></a>`;
                        if(full.status == 1 ){
                          html += ` <a href="javascript:;"  class="text-body"><i data-operation=${full.id}  class="fas fa-arrow-alt-circle-right text-primary process-operation"></i></a>
                                    <a href="javascript:;"  class="text-body"><i data-operation=${full.id}  class="far fa-times-circle text-danger cancel-operation"></i></a>`
                        }else if(full.status == 2){
                          html+= `  <a href="javascript:;"  class="text-body"><i data-operation=${full.id}  class="fas fa-check-circle text-success process-operation"></i></a>
                                    <a href="javascript:;"  class="text-body"><i data-operation=${full.id}  class="far fa-times-circle text-danger cancel-operation"></i></a>`
                        }else{
          ...
          activeOptionsTable() {
            document.querySelectorAll('.view-op').forEach(item => {
              item.addEventListener('click', event => {
                this.selectAccountToAction(event.target.dataset.operation).then((data) => {
                  setTimeout(()=>{
                    this.showModal('operationModal', 1)
                  },500)
                })
            ...
            document.querySelectorAll('.process-operation').forEach(item => {
              item.addEventListener('click', event => {
                this.selectAccountToAction(event.target.dataset.operation).then(() => {
                  setTimeout(()=>{
                    this.showModal('processModal', 2)
                  },500)
                })
            ...
            document.querySelectorAll('.cancel-operation').forEach(item => {
              item.addEventListener('click', event => {
                this.selectAccountToAction(event.target.dataset.operation).then(() => {
                  setTimeout(()=>{
                    this.showModal('processModal', 3)
                  },500)
                })
          ...
          resetFilter(){
            ...
            this.tabled.clear();
            this.tabled.columns().search('').draw('full-hold')
          },
        },
        mounted(){
