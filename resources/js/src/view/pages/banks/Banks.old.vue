            ...
            <div class="card card-custom gutter-b example example-compact">
                    ...
                    <div class="row w-100">
                        ...
                        <div class="col-lg-8 col-md-12 col-sm-12">
                            <div class="row justify-content-end">
                                <button class="btn btn-primary font-weight-bold ml-2" v-b-modal.modal-new-bank>Nuevo banco</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row m-2">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 mr-2">
                            <a class="btn btn-light-primary px-6 font-weight-bold cursor-pointer mr-2" @click="filterBanks()">Buscar</a>
                    ...
                    <div class="row" v-if="!showFilteredBanks">
                        <div class="col-lg-3 col-md-6 col-sm-12" v-for="bank in banks" :key="bank.id">
                            <div class="card card-custom gutter-b card-stretch">
                                <div class="card-body text-center">
                                    ...
                                    <div class="mt-4">
                                        <a v-if="bank.deleted_at == null" @click="setSelectedBank(bank)" class="btn btn-light-primary btn-sm mr-2 mt-2 cursor-pointer" v-b-modal.modal-update-bank >
                                            <i class="far fa-edit"></i>
                                            Editar
                                        </a>
                                        <a v-if="bank.deleted_at == null" @click="deleteBank(bank.id)" class="btn btn-light-danger btn-sm mr-2 mt-2 cursor-pointer">
                    ...
                    <div class="row" v-if="showFilteredBanks">
                        <div class="col-lg-3 col-md-6 col-sm-12" v-for="bank in filteredBanks" :key="bank.id">
                            <div class="card card-custom gutter-b card-stretch">
                                <div class="card-body text-center">
                                    <div class="mt-2">
                                        <a class="text-dark font-weight-bold text-hover-primary font-size-h4">{{ bank.name }}</a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                        <div class="symbol symbol-lg-100">
                            <img :src="logo" alt="Logo del banco">
                        </div>
                    </div>
                </div>
