...
<template>
  ...
  >
    ...
    <a class="" @click="dropdow = !dropdow">
      ...
      <!-- 👉 Title -->
      <span class="nav-item-title" @click="dropdow = !dropdow">{{item.title}} </span>
      <VIcon :icon=" dropdow ? 'bx-chevron-down' : 'bx-chevron-right'" @click="dropdow = !dropdow" />  
    </a>
    <ul class="ms-4">
