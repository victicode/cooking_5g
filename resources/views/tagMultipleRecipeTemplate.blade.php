...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Etiquetas multiples</title>
        <link
            ...
            @foreach($recipes as $key)
              @for ($i = 1; $i < $key->quantity+1; $i++)
                <div class="col-sm-6 px-0 height-tag"   data-id="2">
                  <div class="card py-1 px-0 ps-1">
                    <div class="card-body">
                      <h3 class="card-title text-justify text-decoration-underline super-text">{{$key->recipe->title}} </h3>
                      <div class="row m-0 px-0">
                        <div class="col-sm-10 px-0">
                          <div class="space-text">
                            <b>FECHA DE ELABORACIÓN:</b> <span> {{$key->created}} </span>
                          </div>
                          <div class="space-text">
                            <b>CONSUMIR ANTES DE:</b> <span> {{$key->consumo}} </span>
                          </div>
                          <div class="space-text">
                            <b>CADUCIDAD:</b> <span>
                          ...
                          <div class="space-text">
                            ...
                            <span>
                              @php
                              echo allIngredientsRecipe($key->recipe)
                              @endphp
