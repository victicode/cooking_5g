...
class Order extends Model
{
    ...
    protected $statuses = array(
        0   =>  [
            'status' => 'Cancelado',
            'svg'    => 'http://192.168.31.60/images/status/cancel.svg',
        ],
        1   =>  [
            'status' => 'Pendiente',
            'svg'    => 'http://192.168.31.60/images/status/pending.svg',
        ],
        2   =>  [
            'status' => 'En transito',
            'svg'    => 'http://192.168.31.60/images/status/in_transit.svg',
        ],
        3   =>  [
            'status' => 'Entregado', 
            'svg'    => 'http://192.168.31.60/images/status/confirm.svg',
        ],
    );
